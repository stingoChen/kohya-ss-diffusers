...
from diffusers import (
    ...
    DPMSolverSDEScheduler,                   # 2023-4-21 13:10:21
...
def main(args):
    ...
    elif args.sampler == "dpmsolver" or args.sampler == "dpmsolver++":                     # dpm++2M K
        scheduler_cls = DPMSolverMultistepScheduler
        sched_init_args["use_karras_sigmas"] = True
        sched_init_args["algorithm_type"] = args.sampler
        scheduler_module = diffusers.schedulers.scheduling_dpmsolver_multistep
    elif args.sampler == "dpmSD" or args.sampler == "dpmSD++":                     # dpm++SD K  2023-4-21 13:09:38
        scheduler_cls = DPMSolverSDEScheduler
        sched_init_args["use_karras_sigmas"] = True
        sched_init_args["seed_init"] = args.seed                   # cxk
        # sched_init_args["algorithm_type"] = args.sampler
